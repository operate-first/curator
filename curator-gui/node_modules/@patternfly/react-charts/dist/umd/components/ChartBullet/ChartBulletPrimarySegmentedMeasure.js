(function (global, factory) {
   ...
   */
  const ChartBulletPrimarySegmentedMeasure = exports.ChartBulletPrimarySegmentedMeasure = ({
    allowTooltip = true,
    ariaDesc,
    ariaTitle,
    ...
    const measure = computedData.map((dataPoint, index) => React.cloneElement(measureComponent, _objectSpread({
      barWidth,
