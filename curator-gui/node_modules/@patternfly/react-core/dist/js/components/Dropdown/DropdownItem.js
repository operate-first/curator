...
exports.DropdownItem = (_a) => {
    ...
    additionalChild, customChild, tabIndex = -1, icon = null } = _a, props = tslib_1.__rest(_a, ["children", "className", "component", "isDisabled", "isPlainText", "isHovered", "href", "tooltip", "tooltipProps", "listItemClassName", "onClick", "ref", "additionalChild", "customChild", "tabIndex", "icon"]);
