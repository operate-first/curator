...
exports.DrilldownMenu = (_a) => {
    ...
    react_1.default.createElement(MenuContext_1.MenuContext.Consumer, null, (_a) => {
        ...
        return (react_1.default.createElement(Menu_1.Menu, Object.assign({ id: id, parentMenu: menuId, isMenuDrilledIn: isMenuDrilledIn, ref: react_1.default.createRef() }, context, props),
