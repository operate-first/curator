    ...
    const renderItem = (onSelect, activeItemId, selected, isOnPath, drill) => {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(Component, Object.assign({ onClick: (event) => {
                    ...
                    drill && drill();
                }, className: react_styles_1.css(menu_1.default.menuItem, getIsSelected() && menu_1.default.modifiers.selected, className), "aria-current": getAriaCurrent() }, (isDisabled && { disabled: true }), additionalProps),
