...
class Modal extends React.Component {
    ...
    render() {
        ...
        appendTo, 'aria-labelledby': ariaLabelledby, 'aria-label': ariaLabel, 'aria-describedby': ariaDescribedby, title } = _a, props = tslib_1.__rest(_a, ["appendTo", 'aria-labelledby', 'aria-label', 'aria-describedby', "title"]);
        const { container } = this.state;
        if (!helpers_1.canUseDOM || !container) {
            return null;
        }
        return ReactDOM.createPortal(React.createElement(ModalContent_1.ModalContent, Object.assign({}, props, { boxId: this.boxId, labelId: this.labelId, descriptorId: this.descriptorId, title: title, "aria-label": ariaLabel, "aria-describedby": ariaDescribedby, "aria-labelledby": ariaLabelledby })), container);
    }
}
exports.Modal = Modal;
Modal.currentId = 0;
