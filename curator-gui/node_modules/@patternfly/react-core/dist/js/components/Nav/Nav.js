...
class Nav extends React.Component {
    ...
    render() {
        ...
        onSelect, 
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        onToggle, theme, ouiaId, variant } = _a, props = tslib_1.__rest(_a, ['aria-label', "children", "className", "onSelect", "onToggle", "theme", "ouiaId", "variant"]);
        ...
        return (React.createElement(exports.NavContext.Provider, { value: {
            ...
            React.createElement("nav", Object.assign({ className: react_styles_1.css(nav_1.default.nav, theme === 'light' && nav_1.default.modifiers.light, isHorizontal && nav_1.default.modifiers.horizontal, variant === 'tertiary' && nav_1.default.modifiers.tertiary, this.state.isScrollable && nav_1.default.modifiers.scrollable, className), "aria-label": ariaLabel || variant === 'tertiary' ? 'Local' : 'Global' }, helpers_1.getOUIAProps('Nav', ouiaId), props), children)));
    }
}
exports.Nav = Nav;
Nav.defaultProps = {
