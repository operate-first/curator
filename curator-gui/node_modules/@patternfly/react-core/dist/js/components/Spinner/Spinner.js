...
exports.Spinner = (_a) => {
    ...
    return (React.createElement("span", Object.assign({ className: react_styles_1.css(spinner_1.default.spinner, spinner_1.default.modifiers[size]), role: "progressbar", "aria-valuetext": ariaValueText }, props),
