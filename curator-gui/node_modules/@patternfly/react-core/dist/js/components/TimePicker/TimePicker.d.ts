...
export declare class TimePicker extends React.Component<TimePickerProps, TimePickerState> {
    ...
    onSelect: (selection: string, event: React.MouseEvent | React.KeyboardEvent) => void;
    onInputFocus: (e: any) => void;
    onInputChange: (time: string, event?: React.FormEvent<HTMLInputElement> | React.MouseEvent | React.KeyboardEvent) => void;
