...
class TreeViewRoot extends React.Component {
    ...
    render() {
        ...
        const _a = this.props, { children, hasChecks } = _a, props = tslib_1.__rest(_a, ["children", "hasChecks"]);
        return (React.createElement("div", Object.assign({ className: react_styles_1.css(tree_view_1.default.treeView), ref: this.treeRef }, props), children));
    }
}
