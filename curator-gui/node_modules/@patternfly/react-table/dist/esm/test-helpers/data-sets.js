...
export const editableColumns = ['Text input col 1', 'Disabled text input col 2', 'Text input col 3', 'Text input col 4'];
export const editableRows = [{
  isEditable: true,
  cells: [{
    title: (value, rowIndex, cellIndex, props) => React.createElement(EditableTextCell, {
      value: value,
      rowIndex: rowIndex,
      cellIndex: cellIndex,
      props: props,
