...
var _longArrowAltUpIcon = _interopRequireDefault(require("@patternfly/react-icons/dist/js/icons/long-arrow-alt-up-icon"));

var _longArrowAltDownIcon = _interopRequireDefault(require("@patternfly/react-icons/dist/js/icons/long-arrow-alt-down-icon"));

var _arrowsAltVIcon = _interopRequireDefault(require("@patternfly/react-icons/dist/js/icons/arrows-alt-v-icon"));
...
var SortColumn = function SortColumn(_ref) {
  ...
  if (isSortedBy) {
    SortedByIcon = sortDirection === _Table.SortByDirection.asc ? _longArrowAltUpIcon["default"] : _longArrowAltDownIcon["default"];
  } else {
    SortedByIcon = _arrowsAltVIcon["default"];
  }
