(function (global, factory) {
  ...
  const rowEditTransforms = ({
    ...
    title: '',
    cellTransforms: [_transformers.editable]
  }] : [])];
  /**
  ...
  const calculateColumns = exports.calculateColumns = (headerRows, extra) => headerRows && [...collapsibleTransfroms(extra), ...selectableTransforms(extra), ...expandContent(headerRows, extra), ...rowEditTransforms(extra), ...actionsTransforms(extra)].map((oneCol, key) => _objectSpread({}, mapHeader(oneCol, extra, key)));
});
