...
var NotificationDrawerList = function NotificationDrawerList(_ref) {
  var children = _ref.children,
      _ref$className = _ref.className,
      className = _ref$className === void 0 ? '' : _ref$className,
      _ref$isHidden = _ref.isHidden,
      isHidden = _ref$isHidden === void 0 ? false : _ref$isHidden,
      props = _objectWithoutProperties(_ref, ["children", "className", "isHidden"]);

  return React.createElement("ul", _extends({}, props, {
    className: (0, _reactStyles.css)(_notificationDrawer["default"].notificationDrawerList, className),
    hidden: isHidden
  }), children);
};

exports.NotificationDrawerList = NotificationDrawerList;
NotificationDrawerList.propTypes = {
