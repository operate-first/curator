...
var _c_pagination__nav_page_select_c_form_control_width_chars = _interopRequireDefault(require("@patternfly/react-tokens/dist/js/c_pagination__nav_page_select_c_form_control_width_chars"));
...
var handleInputWidth = function handleInputWidth(lastPage, node) {
  ...
  if (len >= 3) {
    node.style.setProperty(_c_pagination__nav_page_select_c_form_control_width_chars["default"].name, "".concat(len));
  } else {
    node.style.setProperty(_c_pagination__nav_page_select_c_form_control_width_chars["default"].name, '2');
  }
};
