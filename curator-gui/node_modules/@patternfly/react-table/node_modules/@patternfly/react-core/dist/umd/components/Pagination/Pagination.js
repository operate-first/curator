(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "../Dropdown", "./ToggleTemplate", "@patternfly/react-styles/css/components/Pagination/pagination", "@patternfly/react-styles", "./Navigation", "./PaginationOptionsMenu", "../withOuia", "@patternfly/react-tokens/dist/js/c_pagination__nav_page_select_c_form_control_width_chars"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("../Dropdown"), require("./ToggleTemplate"), require("@patternfly/react-styles/css/components/Pagination/pagination"), require("@patternfly/react-styles"), require("./Navigation"), require("./PaginationOptionsMenu"), require("../withOuia"), require("@patternfly/react-tokens/dist/js/c_pagination__nav_page_select_c_form_control_width_chars"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.Dropdown, global.ToggleTemplate, global.pagination, global.reactStyles, global.Navigation, global.PaginationOptionsMenu, global.withOuia, global.c_pagination__nav_page_select_c_form_control_width_chars);
    global.undefined = mod.exports;
  }
})(this, function (exports, _propTypes, _react, _Dropdown, _ToggleTemplate, _pagination, _reactStyles, _Navigation, _PaginationOptionsMenu, _withOuia, _c_pagination__nav_page_select_c_form_control_width_chars) {
  "use strict";
  ...
  var _c_pagination__nav_page_select_c_form_control_width_chars2 = _interopRequireDefault(_c_pagination__nav_page_select_c_form_control_width_chars);
  ...
  const handleInputWidth = (lastPage, node) => {
    ...
    if (len >= 3) {
      node.style.setProperty(_c_pagination__nav_page_select_c_form_control_width_chars2.default.name, `${len}`);
    } else {
      node.style.setProperty(_c_pagination__nav_page_select_c_form_control_width_chars2.default.name, '2');
    }
  };
