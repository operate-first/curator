(function (global, factory) {
  ...
  class Tabs extends React.Component {
    ...
    handleTabClick(event, eventKey, tabContentRef, mountOnEnter) {
      ...
      if (tabContentRef) {
        React.Children.toArray(this.props.children).filter(child => child.props && child.props.tabContentRef && child.props.tabContentRef.current).forEach(child => child.props.tabContentRef.current.hidden = true); // most recently selected tabContent
    ...
    render() {
      ...
      }, React.createElement(_angleRightIcon2.default, null))), React.Children.toArray(children).filter(child => child && child.props.children && !(unmountOnExit && child.props.eventKey !== activeKey) && !(mountOnEnter && shownKeys.indexOf(child.props.eventKey) === -1)).map((child, index) => React.createElement(_TabContent.TabContent, {
        key: index,
        activeKey: activeKey,
        child: child,
