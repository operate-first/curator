...
describe('Table', function () {
  it('shows message when no data', function () {
    ...
    shallowRenderer.render(_react2.default.createElement(_Table2.default, { columns: columns, dataArray: [], keys: 'test' }));
  ...
  it('render simple', function () {
    var columns = [{ title: 'Test', prop: 'test' }];
    var shallowRenderer = _shallow2.default.createRenderer();
    shallowRenderer.render(_react2.default.createElement(_Table2.default, { columns: columns, dataArray: [{ test: 'Foo' }], keys: 'test' }));
